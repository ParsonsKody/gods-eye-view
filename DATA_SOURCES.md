...
| **NRC Power Reactor Status** (daily text file, keyless) | Output row on nuclear plant cards, derated units in the ISO Congestion chips and on constrained-line cards; `/api/reactors` | U.S. public domain | "U.S. Nuclear Regulatory Commission" (courtesy) |
