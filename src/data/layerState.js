...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'eia-transmission-lines', token: 'l', disposition: 'enabled-only' }),
  Object.freeze({ id: 'flights', token: 'f', disposition: 'enabled+options', optionOwner: 'flights' }),
  Object.freeze({ id: 'iso-interface-flows', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'iso-lmp', token: 'n', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'local-power-plants', token: 'p', disposition: 'enabled-only' }),
